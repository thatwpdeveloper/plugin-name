...
class Core {
	...
	private function load_dependencies() {
		...
		$this->loader = new \Plugin_Name\Loader();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new \Plugin_Name\Admin_Code( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new \Plugin_Name\Public_Code( $this->get_plugin_name(), $this->get_version() );
